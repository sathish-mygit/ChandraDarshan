...
const LABELS: Record<LabelKey, Record<AppLanguage, string>> = {
  ...
  locationDescription: {
    en: 'Panchang timings (tithi, sunrise, moonrise, and more) are calculated from your latitude, longitude, and local timezone — accurate anywhere on Earth. Use GPS for your exact position. The city list offers quick picks for major Indian cities.',
    hi: 'पंचांग समय (तिथि, सूर्योदय, चंद्रोदय आदि) आपके अक्षांश, देशांतर और स्थानीय समय क्षेत्र से गणना होते हैं — पृथ्वी पर कहीं भी सटीक। सटीक स्थान के लिए GPS का उपयोग करें। शहर सूची प्रमुख भारतीय शहरों के लिए शॉर्टकट है।',
    sa: 'पञ्चाङ्गसमयाः (तिथिः, सूर्योदयः, चन्द्रोदयश्च) भवतः अक्षांशदेशान्तरस्थानीयकालक्षेत्रैः गण्यन्ते — पृथिव्यां सर्वत्र सटीकम्। सटीकस्थानाय GPS प्रयुज्यताम्। नगरसूची प्रमुखभारतीयनगराणां कृते शीघ्रविकल्पः।',
    te: 'పంచాంగ సమయాలు (తిథి, సూర్యోదయం, చంద్రోదయం మొదలైనవి) మీ అక్షాంశం, రేఖాంశం మరియు స్థానిక సమయ క్షేత్రం నుండి లెక్కించబడతాయి — భూమిపై ఎక్కడైనా ఖచ్చితంగా. ఖచ్చితమైన స్థానం కోసం GPS ఉపయోగించండి. నగర జాబితా ప్రధాన భారతీయ నగరాల కోసం శీఘ్ర ఎంపికలు.',
    ta: 'பஞ்சாங்க நேரங்கள் (திதி, சூரிய உதயம், சந்திர உதயம் போன்றவை) உங்கள் அட்சரேகை, தீர்க்கரேகை மற்றும் உள்ளூர் நேர மண்டலத்திலிருந்து கணக்கிடப்படுகின்றன — பூமியில் எங்கும் துல்லியமாக. துல்லியமான இடத்திற்கு GPS பயன்படுத்துங்கள். நகர பட்டியல் முக்கிய இந்திய நகரங்களுக்கான விரைவு தேர்வுகள்.',
  },
  masaSystem: {
