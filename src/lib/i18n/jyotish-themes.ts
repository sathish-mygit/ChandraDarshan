...
const YOGA_DESCRIPTIONS: Record<string, LocalizedText> = {
  ...
  'Raja Yoga': {
    en: 'Kendra-trikona lords combine — potential for rise and recognition.',
    hi: 'कendra-त्रिकोण स्वामी योग — उन्नति और मान्यता की संभावना।',
    sa: 'केन्द्रत्रिकोणस्वामियोगः — उन्नतिप्रतिष्ठासम्भावना।',
    te: 'కేంద్ర-త్రికోణ స్వామి యోగం — ఎదుగుదల మరియు గుర్తింపు సాధ్యత.',
    ta: 'கேந்திர-திரிகோண அதிபதி யோகம் — உயர்வுக்கும் அங்கீகாரத்திற்கும் வாய்ப்பு.',
  },
  'Lakshmi Yoga': {
